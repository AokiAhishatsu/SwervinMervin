...
class WorldObject:
	...
	def render(self, window, segment):
		...
		if 0 < s_width < s.DIMENSIONS[0] * 2 and s_height > 0 and top_clip > 0 and s_height < s.DIMENSIONS[1] * 2 and (
				left_clip >= 0 or abs(left_clip) < s_width) and not self.non_renderable():
